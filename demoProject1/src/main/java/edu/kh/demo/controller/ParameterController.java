...
public class ParameterController {
	...
	/* Spring의 Controller메서드 작성 시
	 * 매개 변수에 원하는 객체를 작성하면
	 * 존재하는 객체를 바인딩 또는 없으면 생성
	 * 
	 *  --> ArgumentResolver(전달 인자 해결사) 
	 * 
	 */
	
	@PostMapping("test1") // /param/test1 POST 발식 요청 매핑
	public String paramTset1(
	...
	public String paramTest3(
		...
		//  -> 같은 name속성 파라미터가 Sting[], List로 저장 
